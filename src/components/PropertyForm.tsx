              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => form.setValue('floor', value)}
                  >
                    <SelectTrigger>
                ...
                <div>
                  <Label htmlFor="total_floors">{t.totalFloors}</Label>
                  <Select 
                    value={form.watch('total_floors') || ''} 
                    onValueChange={(value) => form.setValue('total_floors', value)}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder={t.totalFloors} />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="1">1</SelectItem>
                      <SelectItem value="2">2</SelectItem>
              ...
              {(watchedType === 'rent' || watchedType === 'both') && (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="max_occupants">{t.maxOccupants}</Label>
                      <Select 
                        value={form.watch('max_occupants') || ''} 
                        onValueChange={(value) => form.setValue('max_occupants', value)}
                      >
                        <SelectTrigger>
                          <SelectValue placeholder={t.maxOccupants} />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="1">1</SelectItem>
                          <SelectItem value="2">2</SelectItem>
