export interface Translation {
  ...
  viewProjects: string;
  aboutCreativeCCS: string;
  whoAreWe: string;
  whoAreWeDesc: string;
  decadeOfExcellence: string;
  decadeOfExcellenceDesc: string;
  ...
  comprehensiveServicesTailored: string;
  realEstateServicesTitle: string;
  maintenanceServicesTitle: string;
  keyFeaturesDesc: string;
  marketAnalysisDesc: string;
  modernConstructionMethodsTitle: string;
  modernConstructionMethodsDesc: string;
  features: string;
  keyFeatures: string;
  marketAnalysis: string;
  innovativeSolutions: string;
  supportingVision: string;
  supportingVisionDesc: string;
  visionGoal: string;
  commitment: string;
  visionMission: string;
  visionMissionDesc: string;
  vision: string;
  visionDesc: string;
  mission: string;
  missionDesc: string;
  ourTrustedPartners: string;
  ourTrustedPartnersDesc: string;
